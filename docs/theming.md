...
> [!NOTE]
> The default data directory was changed when Muzak was renamed to Hummingbird.
>
...
Colors are specified as CSS-style hex codes (`#ABCDEF`). Use `#00000000` for fully
...
```json
{
  ...
  "button_danger": "#650B0B",
  "button_danger_border": "#860808",
  "button_danger_hover": "#750C0C",
  "button_danger_border_hover": "#8F0B0B",
  "button_danger_active": "#440A0A",
  "button_danger_border_active": "#650707",
  ...
  "textbox_background": "#373B4E",
  "textbox_border": "#4F5267",
